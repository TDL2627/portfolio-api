...
app.get("/projects", function (req, res) {
  let projects = [
    ...
    { title: 'Omnibar', description: 'A unique navbar I created myself from scratch using Javascript.', level: "Moderate", img: "omni.png", linkGit: "https://github.com/TDL2627/omniBar", linkLive: "https://omnibar.netlify.app/" },
    { title: 'myMentor', description: 'An app made for first year university students to help them with their transition.It has multiple features made with VUE JS', level: "Advanced", img: "mentor.png", linkGit: "https://github.com/TDL2627/myMentor", linkLive: "https://mymentor2627.web.app/" },
    { title: 'TLC', description: 'A business learning site made with VITE and Tail wind.', level: "Moderate", img: "tlc.png", linkGit: "https://github.com/TDL2627/theLearningCentre", linkLive: "https://learningcentr3.web.app/" },
    { title: 'Elementals', description: 'A rock paper scissors game made with VUE JS.', level: "Moderate", img: "elemental.png", linkGit: "https://github.com/TDL2627/Rock-paper-vue", linkLive: "https://elementals2627.web.app/" },
    { title: 'Tic Tac Toe', description: 'A multiplayer game made with React JS. ', level: "Moderate", img: "tictac.png", linkGit: "https://github.com/TDL2627/React-tic-tac", linkLive: "https://tictac2627.web.app/" },
